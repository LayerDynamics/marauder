...
const KEYBINDING_ACTIONS: { mod: string; key: string; action: string }[] = [
  ...
  { mod: "Mod", key: "D", action: "split-pane-horizontal" },
  { mod: "Mod+Shift", key: "D", action: "split-pane-vertical" },
  { mod: "Alt", key: "Left", action: "focus-pane-left" },
  { mod: "Alt", key: "Right", action: "focus-pane-right" },
  { mod: "Alt", key: "Up", action: "focus-pane-up" },
  { mod: "Alt", key: "Down", action: "focus-pane-down" },
